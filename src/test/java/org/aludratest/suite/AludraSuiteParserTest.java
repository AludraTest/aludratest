...
public class AludraSuiteParserTest extends AbstractAludraServiceTest {
    ...
    public void testTestClassWithoutParent() {
        try {
            ...
            String expectedMessage = "Test class org.aludratest.suite.AludraSuiteParserTest$TestClassWithoutParent "
    ...
    public void testEmptyTestClass() {
        try {
            ...
            String expectedMessage = "No @Test methods found in class "
                    + "org.aludratest.suite.AludraSuiteParserTest$EmptyTestClass";
            assertEquals(expectedMessage, e.getMessage());
        }
    }
    ...
    public void testParallelTestClass() {
        ...
        RunnerTree tree = new AludraSuiteParser(aludra).parse(testClass.getName());
