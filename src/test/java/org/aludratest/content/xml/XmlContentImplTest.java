...
public class XmlContentImplTest {
    ...
    public void testDiff_otherAttributeVal() {
        ...
        assertEquals(DatabeneXmlUtil.different("val", "val2", "attribute", "/root/@att"), diff.getXmlDetails().get(0));
    }
    ...
    public void testDiff_otherElementText() throws Exception {
        ...
        XmlDiffDetail expectedDiff = DatabeneXmlUtil.different(expectedText, actualText, "element text", "/root/node");
