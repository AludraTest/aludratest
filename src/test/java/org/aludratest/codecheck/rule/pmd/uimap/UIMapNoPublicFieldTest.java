...
import org.aludratest.codecheck.rule.pmd.uimap.UIMapNoPublicField;
import org.junit.Test;
import org.test.testclasses.uimap.ConstructingUIMap;
import org.test.testclasses.uimap.NonCompliantUIMap;

public class UIMapNoPublicFieldTest extends AbstractPmdTestCase {

    @Test
    public void testInvalidClass() {
        Report report = runPmdTest(NonCompliantUIMap.class, new UIMapNoPublicField());
    ...
    public void testValidClass() {
        Report report = runPmdTest(ConstructingUIMap.class, new UIMapNoPublicField());
