...
public class DataClassNoArgConstructorTest extends AbstractPmdTestCase {
    ...
    @Test
    public void testValidClassWithNoConstructor() {
        Report report = runPmdTest(NoToStringData.class, new DataClassNamingConvention());
        assertReportViolations(report, 0);
    }

    @Test
    public void testValidClassWithExplicitConstructor() {
        Report report = runPmdTest(ToStringInParentData.class, new DataClassNamingConvention());
        assertReportViolations(report, 0);
    }
