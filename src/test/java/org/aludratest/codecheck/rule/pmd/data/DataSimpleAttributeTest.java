...
import org.aludratest.codecheck.rule.pmd.data.DataSimpleAttribute;
import org.junit.Test;
import org.test.testclasses.data.NonCompliantData;
import org.test.testclasses.data.ToStringInParentData;

public class DataSimpleAttributeTest extends AbstractPmdTestCase {

    @Test
    public void testIllegalClass() {
        Report report = runPmdTest(NonCompliantData.class, new DataSimpleAttribute());
        assertReportViolations(report, 2);
    }

    @Test
    public void testValidClass() {
        Report report = runPmdTest(ToStringInParentData.class, new DataSimpleAttribute());
