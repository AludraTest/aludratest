...
import org.aludratest.codecheck.rule.pmd.data.DataNoStaticAttributes;
import org.junit.Test;
import org.test.testclasses.data.NonCompliantData;
import org.test.testclasses.data.ToStringInParentData;

public class DataNoStaticAttributesTest extends AbstractPmdTestCase {

    @Test
    public void testIllegalClass() {
        Report report = runPmdTest(NonCompliantData.class, new DataNoStaticAttributes());
        assertReportViolations(report, 1);
    }

    @Test
    public void testValidClass() {
        Report report = runPmdTest(ToStringInParentData.class, new DataNoStaticAttributes());
