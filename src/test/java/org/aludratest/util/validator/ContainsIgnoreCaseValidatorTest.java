...
public class ContainsIgnoreCaseValidatorTest extends AbstractValidatorTest {

    @Test
    public void testPositive() {
        ContainsIgnoreCaseValidator validator = new ContainsIgnoreCaseValidator("TEST");
    ...
    public void testNullValidator() {
        ContainsIgnoreCaseValidator validator = new ContainsIgnoreCaseValidator(null);
        assertTrue(validator.valid("TEST"));
    }

    @Test
    public void testNullMarkedValidator() {
        ContainsIgnoreCaseValidator validator = new ContainsIgnoreCaseValidator(NULL_MARKER);
        assertTrue(validator.valid("TEST"));
    }
