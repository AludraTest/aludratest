 ...
 * 
 */
public class AWLNoNonFinalStaticAttribute extends AbstractAludraTestRule {

	@Override
	public Object visit(ASTFieldDeclaration node, Object data) {
        if (!node.isStatic() || node.isFinal() || !isAWLClass(node)) {
			return super.visit(node, data);
        }

		addViolationWithMessage(data, node, "Do not use static, non-final fields");
