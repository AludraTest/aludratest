 ...
 * 
 */
public class PageHelperUsageRestriction extends AbstractUsageRestrictionRule {

    @Override
    protected UsageRestrictionCheck createUsageRestrictionCheck() {
        UsageRestrictionCheck pageHelperUsageCheck = new UsageRestrictionCheck(PageHelper.class);
    ...
    public Object visit(ASTClassOrInterfaceDeclaration node, Object data) {
        if (!isPageHelperClass(node) && !isPageClass(node)) {
