 ...
 * 
 */
public class PageNoPublicAttribute extends AbstractAludraTestRule {

	@Override
	public Object visit(ASTFieldDeclaration node, Object data) {
        if (node.isStatic() || !node.isPublic() || !isPageClass(node)) {
			return super.visit(node, data);
		}

        addViolationWithMessage(data, node, "Do not use public attributes in Page classes");
