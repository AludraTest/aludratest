 ...
 * 
 */
public class DataFieldsMustNotBePublic extends AbstractAludraTestRule {
    ...
    public Object visit(ASTFieldDeclaration node, Object data) {
        ...
        if (node.isPublic()) {
            addViolationWithMessage(data, node, "Fields in Data classes must not be public; add getter and setter methods");
        }
