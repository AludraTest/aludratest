 ...
 */
public class ContainsIgnoreCaseValidator extends AbstractNullStringValidator {

    /** Constructor.
     *  @param expectedSubString the required sub string */
    public ContainsIgnoreCaseValidator(String expectedSubString) {
    ...
    protected String descriptionImpl() {
        return "expecting a sub string '" + validationTerm + "' ignoring case";
    }
