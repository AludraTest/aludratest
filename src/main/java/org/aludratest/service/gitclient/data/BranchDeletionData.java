...
/** Wraps data for the invocation of the {@link GitClient}'s deleteBranch method.
 * @see GitClient#deleteBranch(BranchDeletionData)
 * @author Volker Bergmann */
public class BranchDeletionData extends AbstractGitData {
